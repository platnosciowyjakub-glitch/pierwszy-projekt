...
export const prezenty = {
  ...
  tool: {
    ...
    sending: "Wysyłam…",
    sentTitle: "Link jest już w drodze.",
    sentText: "Otwórz wiadomość od Gviazdki i kliknij link. Jeśli jej nie widzisz, zajrzyj do folderu z ofertami lub spamem.",
    emailInvalid: "Ten adres wygląda na niepełny. Sprawdź go proszę jeszcze raz.",
    loginError: "Nie udało się wysłać linku. Spróbuj proszę za chwilę.",
